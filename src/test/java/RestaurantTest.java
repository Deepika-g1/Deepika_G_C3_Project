...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        //WRITE UNIT TEST CASE HERE
        LocalTime openingTime = LocalTime.parse("06:30:00");
    ...
    //<<<<<<<<<<<<<<<<<<<<<<<<<OPEN/CLOSED>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    @Test
    public void item_added_to_menu_should_return_the_price_more_than_zero() {
        addRestaurantDetails();
        restaurant.addToMenu("Brocolli soup", 456);
        int price = restaurant.getCalculatePrice();
        assertEquals(844, price);
    }
